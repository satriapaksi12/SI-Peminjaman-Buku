...
@section('fitur', 'KATEGORI')
@section('link', '/kategori')
@section('nama link', 'Kategori')
                        ...
                        @foreach ($kategori as $data)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="kategori-edit/{{ $data->id }}" title="Edit" class="btn icon btn-warning"><i
                                            class="bi bi-pencil"></i></a>
                                    <form action="/kategori-destroy/{{ $data->id }}" method="post" class="d-inline">
                                        @csrf
                                        @method('delete')
                                        <button
                                            onclick="return confirm('Apakah anda ingin menghapus data kategori buku{{ $data->nama_kategori }} ')"
